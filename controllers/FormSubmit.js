module.exports = function(app){
  ...
  app.post('/api/add/form-submit', function(req,res){
    ...
    var query = "INSERT INTO Applicants_Info_Table(First_Name,Last_Name,Date_of_Birth,Occupation,"
             ...
             +"Revolving_Utilization,Annual_Income,Total_Accounts,Employment_Length,Account_Now_Delinquent,Delinquent_Amount,"
             +"Interest_Rate,Term,FICO_Score,Delinquent_2_Years,Log_Annual_Income,Installment) "
             ...
             +req.body.acc_now_delinq+"','"+req.body.delinquent_amount+"','"+req.body.interest_rate+"','"
             +req.body.term+"','"+req.body.fico_score+"','"+req.body.delinquent_2_years+"','"+req.body.log_annual_income+"','"
